...
`D:\AI\WindowsApp\diary-learning-habit-board`

## 事前準備

1. GitHub Release `v0.1.0-alpha.1` から `dist/diary-learning-habit-board-docs.zip` を取得できることを確認する。
