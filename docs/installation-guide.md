...
2. `dist/diary-learning-habit-board-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を取得する。
3. repo を clone する。

```powershell
git clone https://github.com/Sunmax0731/diary-learning-habit-board.git
cd diary-learning-habit-board
